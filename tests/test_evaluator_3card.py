...
try:
    from ofc_logic import Card, INVALID_CARD # Removed hand_to_int as logic_hand_to_int
except ImportError:
...
def hand_to_int(card_strs: list) -> tuple:
    ...
    ints_optional = Card.hand_to_int(card_strs) # Use Card.hand_to_int directly
